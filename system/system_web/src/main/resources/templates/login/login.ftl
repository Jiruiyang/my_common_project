...
<head>
    ...
    <link rel="stylesheet" href="${base.contextPath}/css/login/login.css" media="all"/>
</head>
<body>
    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item form_code">
            <input class="layui-input" name="code" placeholder="验证码" lay-verify="required" type="text"
                   autocomplete="off">
            <div class="code"><img src="${base.contextPath}/img/code.jpg" width="116" height="36"></div>
        </div>
        <button class="layui-btn login_btn" id="login">登录</button>
    </form>
</div>
<script type="text/javascript" src="${base.contextPath}/third/layui/layui.js"></script>
<script type="text/javascript" src="${base.contextPath}/js/login/login.js"></script>
</body>
</html>